  ...
  const body = JSON.stringify(
    {
      ...
      articles: articles.map((article) => ({
        ...
        // history.json expose per article — so a directory consumer can sort or
        // filter by age or recency without an N-fetch sweep of every article's
        // history. lastEdited completes the recency signal recentchanges.json
        // already exposes per change.
