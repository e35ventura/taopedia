  ...
  const body = JSON.stringify(
    {
      ...
      articles: articles.map((article) => {
        ...
        return {
          ...
          // expose per article and mostlinkedpages.json / subnets.json expose per
          // directory row — so a consumer of the full directory can see each
          // article's age and edit depth without an N-fetch sweep.
