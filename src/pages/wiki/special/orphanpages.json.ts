...
// articles — the complement of Special:MostLinkedPages, which ranks only
// articles with at least one inbound link. Programmatic consumers include
// maintenance dashboards and link-graph tooling that need to find disconnected
// content without scraping per-article backlinks pages.
