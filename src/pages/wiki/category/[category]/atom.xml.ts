...
export async function getStaticPaths() {
  ...
  // The per-category Atom feed below then reads its members by map lookup
  ...
  // preserves collection order, so each feed's item order is unchanged.
  // historyBySlug still caches each categorized article's revision history once
