  ...
  const body = JSON.stringify(
    {
      ...
      // readingMinutes is the ~200-wpm reading-time estimate — the same figure
      // info.json / history.json / toc.json expose and the article-page footer
      // ("N min read") renders from wordCount.
