...
// carries name and url; count equals categories.length; and every listed
// category URL points at a built category hub. Articles that belong to no
// categories carry count: 0 and an empty array — that is valid, not an error.
