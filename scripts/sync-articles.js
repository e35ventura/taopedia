...
const unsafeContentPatterns = [
  ...
  { pattern: /\b(?:redis|rediss|mongodb(?:\+srv)?|mysql|postgresql|postgres|memcached|etcd|consul|snowflake|sqlserver|mssql|timescaledb)\s*:\/\//i, reason: 'database-connection URL schemes are not allowed in article content' },
  ...
  // amqp:// amqps:// mqtt:// mqtts:// stomp:// kafka:// nats:// are message-broker / queue
  // connection URL schemes that address an internal messaging service at a host:port, not an
  ...
  { pattern: /\b(?:amqps|amqp|mqtts|mqtt|stomp|kafka|nats)\s*:\/\//i, reason: 'message-broker connection URL schemes are not allowed in article content' },
  ...
  { pattern: /\b(?:clickhouse|cassandra|couchbase|couchdb|neo4j|bolt|scylla|arangodb)\s*:\/\//i, reason: 'data-store connection URL schemes are not allowed in article content' },
...
const obfuscatedSchemePatterns = [
  ...
  { pattern: /(?:redis|rediss|mongodb(?:\+srv)?|mysql|postgresql|postgres|memcached|etcd|consul|snowflake|sqlserver|mssql|timescaledb)\s*:\/\//i, reason: 'database-connection URL schemes are not allowed in article content' },
  ...
  { pattern: /(?:clickhouse|cassandra|couchbase|couchdb|neo4j|bolt|scylla|arangodb)\s*:\/\//i, reason: 'data-store connection URL schemes are not allowed in article content' },
...
const infoboxRowValueSchemePatterns = [
  ...
  /(?:redis|rediss|mongodb(?:\+srv)?|mysql|postgresql|postgres|memcached|etcd|consul|snowflake|sqlserver|mssql|timescaledb)\s*:\/\//i,
  /(?:git|svn|cvs)\s*:\/\//i,
  /(?:amqps|amqp|mqtts|mqtt|stomp|kafka|nats)\s*:\/\//i,
  /(?:clickhouse|cassandra|couchbase|couchdb|neo4j|bolt|scylla|arangodb)\s*:\/\//i,
  /(?:coaps|coap)\s*:\/\//i,
