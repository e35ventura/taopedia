...
const unsafeContentPatterns = [
  ...
  { pattern: /<\s*(base|frame|frameset|iframe|object|embed|link|meta|style|form|input|button|textarea|select)\b/i, reason: 'active HTML elements are not allowed in article content' },
