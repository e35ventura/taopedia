...
const unsafeContentPatterns = [
  ...
  // clickhouse:// cassandra:// couchbase:// couchdb:// neo4j:// bolt:// zookeeper://
  // hdfs:// hazelcast:// riak:// minio:// solr:// are additional data-store connection URL
  // schemes (analytics / graph / NoSQL / coordination / object storage / search), the sibling
  // of the database-connection and message-broker schemes above: each addresses an internal data
  ...
  { pattern: /\b(?:clickhouse|cassandra|couchbase|couchdb|neo4j|bolt|zookeeper|hdfs|hazelcast|riak|minio|solr)\s*:\/\//i, reason: 'data-store connection URL schemes are not allowed in article content' },
...
const obfuscatedSchemePatterns = [
  ...
  { pattern: /(?:clickhouse|cassandra|couchbase|couchdb|neo4j|bolt|zookeeper|hdfs|hazelcast|riak|minio|solr)\s*:\/\//i, reason: 'data-store connection URL schemes are not allowed in article content' },
...
const infoboxRowValueSchemePatterns = [
  ...
  /(?:clickhouse|cassandra|couchbase|couchdb|neo4j|bolt|zookeeper|hdfs|hazelcast|riak|minio|solr)\s*:\/\//i,
  /(?:coaps|coap)\s*:\/\//i,
