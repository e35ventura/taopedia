...
// char="," combined with a column of decimal "APY" values can decimal-align
// attacker-controlled "earnings" numbers against the wiki's own columns, the
// same content-spoof class as the merged #436 align/valign and #438
// border/cellpadding rules. charoff= is the paired offset and is blocked
// alongside so a partial attribute set still has no effect. Tag-scoped to
// td|th|tr and scanned on emptyQuotedAttributeValues() so benign prose and
// class values pass.
