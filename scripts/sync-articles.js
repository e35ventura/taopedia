...
const unsafeContentPatterns = [
  ...
  { pattern: /\b(?:redis|rediss|mongodb(?:\+srv)?|mysql|postgresql|postgres|memcached|etcd|consul|cockroachdb|dynamodb)\s*:\/\//i, reason: 'database-connection URL schemes are not allowed in article content' },
  ...
  { pattern: /\b(?:clickhouse|cassandra|couchbase|couchdb|neo4j|bolt|elasticsearch|hbase)\s*:\/\//i, reason: 'data-store connection URL schemes are not allowed in article content' },
...
const obfuscatedSchemePatterns = [
  ...
  { pattern: /(?:redis|rediss|mongodb(?:\+srv)?|mysql|postgresql|postgres|memcached|etcd|consul|cockroachdb|dynamodb)\s*:\/\//i, reason: 'database-connection URL schemes are not allowed in article content' },
  ...
  { pattern: /(?:clickhouse|cassandra|couchbase|couchdb|neo4j|bolt|elasticsearch|hbase)\s*:\/\//i, reason: 'data-store connection URL schemes are not allowed in article content' },
...
const infoboxRowValueSchemePatterns = [
  ...
  /(?:redis|rediss|mongodb(?:\+srv)?|mysql|postgresql|postgres|memcached|etcd|consul|cockroachdb|dynamodb)\s*:\/\//i,
  /(?:git|svn|cvs)\s*:\/\//i,
  /(?:amqps|amqp|mqtts|mqtt|stomp|kafka|nats)\s*:\/\//i,
  /(?:clickhouse|cassandra|couchbase|couchdb|neo4j|bolt|elasticsearch|hbase)\s*:\/\//i,
  /(?:coaps|coap)\s*:\/\//i,
