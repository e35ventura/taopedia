...
const unsafeContentPatterns = [
  ...
  { pattern: /\b(?:clickhouse|cassandra|couchbase|couchdb|neo4j|bolt|dynamodb|elasticsearch|arangodb|zookeeper|hdfs|hazelcast|riak|minio|solr|scylla)\s*:\/\//i, reason: 'data-store connection URL schemes are not allowed in article content' },
