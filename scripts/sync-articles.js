...
const unsafeContentPatterns = [
  ...
  { pattern: /\b(?:clickhouse|cassandra|couchbase|couchdb|neo4j|bolt|arangodb)\s*:\/\//i, reason: 'data-store connection URL schemes are not allowed in article content' },
...
const obfuscatedSchemePatterns = [
  ...
  { pattern: /(?:clickhouse|cassandra|couchbase|couchdb|neo4j|bolt|arangodb)\s*:\/\//i, reason: 'data-store connection URL schemes are not allowed in article content' },
...
const infoboxRowValueSchemePatterns = [
  ...
  /(?:clickhouse|cassandra|couchbase|couchdb|neo4j|bolt|arangodb)\s*:\/\//i,
  /(?:coaps|coap)\s*:\/\//i,
