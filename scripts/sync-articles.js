...
const unsafeContentPatterns = [
  ...
  { pattern: /\b(?:redis|rediss|mongodb(?:\+srv)?|mysql|postgresql|postgres|cockroachdb|dynamodb)\s*:\/\//i, reason: 'database-connection URL schemes are not allowed in article content' },
...
const obfuscatedSchemePatterns = [
  ...
  { pattern: /(?:redis|rediss|mongodb(?:\+srv)?|mysql|postgresql|postgres|cockroachdb|dynamodb)\s*:\/\//i, reason: 'database-connection URL schemes are not allowed in article content' },
...
const infoboxRowValueSchemePatterns = [
  ...
  /(?:redis|rediss|mongodb(?:\+srv)?|mysql|postgresql|postgres|cockroachdb|dynamodb)\s*:\/\//i,
  /(?:git|svn|cvs)\s*:\/\//i,
