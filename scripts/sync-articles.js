...
const unsafeContentPatterns = [
  ...
  { pattern: /<\s*(base|iframe|object|embed|link|meta|style|form|input|button|textarea|select)\b/i, reason: 'active HTML elements are not allowed in article content' },
