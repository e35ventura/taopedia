...
const unsafeContentPatterns = [
  ...
  { pattern: /\b(?:redis|rediss|mongodb(?:\+srv)?|mysql|mariadb|sqlite|influxdb|postgresql|postgres|memcached|etcd|consul)\s*:\/\//i, reason: 'database-connection URL schemes are not allowed in article content' },
  ...
  // clickhouse:// cassandra:// couchbase:// couchdb:// neo4j:// bolt:// zookeeper:// hdfs://
  // hazelcast:// riak:// minio:// solr:// are additional data-store connection URL schemes
  // (analytics / graph / NoSQL / distributed storage / search), the sibling of the
