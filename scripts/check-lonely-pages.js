...
// lonelypages.json.ts spreads this helper for revisionCount / firstEdited / lastEdited —
// the same pattern deadendpages.json.ts (#1800) and mostlinkedpages.json.ts use.
{
