...
// attributes. The build emits no id=/name= (no rehype-slug). Slash forms covered;
// unquoted/quoted URL query strings containing id=/name= are NOT flagged.
...
rejects('<a href="/wiki/x/"id="cookie">x</a>', 'quote-abutted a id attribute');
rejects('<a href="/wiki/x/"name="body">x</a>', 'quote-abutted a name attribute');
rejects('Intro.\n\n<div/id="cookie">x</div>', 'slash-delimited id after tag name');
rejects('<a href="/wiki/x/"/id="cookie">x</a>', 'quote-plus-slash-delimited id attribute');
