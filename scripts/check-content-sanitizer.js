...
// amqp:// mqtt:// stomp:// kafka:// nats:// redpanda:// activemq:// nsq:// message-broker
// connection schemes address an internal broker (SSRF targets), never an http(s) article
// link; //-guarded. Coverage spans the plain content scan, the entity-decoded scan, and
// the infobox scan.
...
rejects('See [x](amqp&#115;://internal-host:5671/v).', 'entity-obfuscated amqps:// (obfuscated scan path)');
rejects('See [x](mqt&#116;://internal-host:1883/topic).', 'entity-obfuscated mqtt:// (obfuscated scan path)');
rejects('See [x](mqt&#116;s://internal-host:8883/topic).', 'entity-obfuscated mqtts:// (obfuscated scan path)');
rejects('See [x](kafk&#97;://internal-host:9092).', 'entity-obfuscated kafka:// (obfuscated scan path)');
rejects('See [x](stom&#112;://internal-host:61613).', 'entity-obfuscated stomp:// (obfuscated scan path)');
rejects('See [x](nat&#115;://internal-host:4222).', 'entity-obfuscated nats:// (obfuscated scan path)');
rejects('See [x](rabbit&#109;q://internal-host:5672/vhost).', 'entity-obfuscated rabbitmq:// (obfuscated scan path)');
rejects('See [x](puls&#97;r://internal-host:6650/).', 'entity-obfuscated pulsar:// (obfuscated scan path)');
...
infoboxRowRejects('amqps://internal-host:5671/vhost', 'amqps:// rejected in an infobox row value');
infoboxRowRejects('mqtt://internal-host:1883/topic', 'mqtt:// rejected in an infobox row value');
infoboxRowRejects('mqtts://internal-host:8883/topic', 'mqtts:// rejected in an infobox row value');
infoboxRowRejects('kafka://internal-host:9092', 'kafka:// rejected in an infobox row value');
infoboxRowRejects('stomp://internal-host:61613', 'stomp:// rejected in an infobox row value');
infoboxRowRejects('nats://internal-host:4222', 'nats:// rejected in an infobox row value');
infoboxRowRejects('rabbitmq://internal-host:5672/vhost', 'rabbitmq:// rejected in an infobox row value');
